...
# Nuevas rutas para no mezclar con lo anterior
...
# ---------------------------------------------------------
# PANTALLA 2: SISTEMA PRINCIPAL (TU CÓDIGO ORIGINAL)
# ---------------------------------------------------------
...
# ---------------------------------------------------------
    ...
    with tabs_v[0]:
        if m_gp_vv is None or m_costos_vv is None:
            ...
            with c1v: mes_vv = st.selectbox("Mes VV", ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"])
            with c2v: archivo_vv = st.file_uploader("Subir Carga VV", type=['xlsx', 'xls', 'csv'])
