            ...
            if archivo:
                ...
                if df_raw is not None:
                    ...
                    if len(sin_gp) > 0 or len(sin_tar) > 0:
                        ...
                        # 6. GUARDAR (CORREGIDO PARA NO BORRAR)
