...
# ---------------------------------------------------------
    ...
    with tabs[1]: # DETALLE ORIGINAL
        if 'res_actual' in st.session_state:
            ...
            st.divider(); st.dataframe(df_v, use_container_width=True)

# ---------------------------------------------------------
# PANTALLA 3: VV / REPROGRAMA (SIN MM/MP - SUBTOTAL Y TOTAL OK)
# ---------------------------------------------------------
    ...
    with tabs_v[1]: # DETALLE VV (KPIs y Tabla)
        if 'res_vv_final' in st.session_state:
            ...
            st.divider(); st.dataframe(dv, use_container_width=True)
